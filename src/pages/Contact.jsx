...
const Contact = () => {
  ...
  const handleFocus = (e) => setCurrentAnimations('walk');
  const handleBlur = (e) => setCurrentAnimations('idle');
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      setCurrentAnimations('idle');
      console.log(error);
      showAlert({ show: true, text: "I didn't reciev your message", type: 'danger' })
    })
  };
